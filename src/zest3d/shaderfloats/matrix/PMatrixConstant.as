...
package zest3d.shaderfloats.matrix 
{
	 ...
	 * @author Gary Paluk
	 */
	public class PMatrixConstant extends ShaderFloat implements IDisposable 
	{
		
		public function PMatrixConstant() 
		{
			super( 4 );
			_allowUpdater = true;
		}
		...
		{
			var projMatrix: HMatrix = camera.projectionMatrix;
			
			_data.position = 0;
			var tuple: Array = projMatrix.toTuple();
