...
package zest3d.shaderfloats.light 
{
	 ...
	 * @author Gary Paluk
	 */
	public class LightAmbientConstant extends ShaderFloat implements IDisposable 
	{
		
		protected var _light: Light;
		
		public function LightAmbientConstant( light: Light ) 
		{
			super( 1 );
			_light = light;
			_allowUpdater = true;
		...
		{
			var tuple: Array = _light.ambient.toArray();
			_data.position = 0;
