...
package zest3d.shaderfloats.light 
{
	 ...
	 * @author Gary Paluk
	 */
	public class LightSpecularConstant extends ShaderFloat implements IDisposable 
	{
		
		protected var _light: Light;
		
		public function LightSpecularConstant( light: Light ) 
		{
			super( 1 );
			_light = light;
			_allowUpdater = true;
		...
		{
			var tuple: Array = _light.specular.toArray();
			_data.position = 0;
