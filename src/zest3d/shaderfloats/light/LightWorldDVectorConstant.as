...
package zest3d.shaderfloats.light 
{
	 ...
	 * @author Gary Paluk
	 */
	public class LightWorldDVectorConstant extends ShaderFloat implements IDisposable 
	{
		
		protected var _light: Light;
		
		public function LightWorldDVectorConstant( light: Light ) 
		{
			super( 1 );
			_light = light;
			_allowUpdater = true;
		...
		{
			var tuple: Array = _light.dVector.toTuple();
