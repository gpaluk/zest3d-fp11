...
package zest3d.shaderfloats.camera 
{
	 ...
	 * @author Gary Paluk
	 */
	public class CameraWorldPositionConstant extends ShaderFloat implements IDisposable 
	{
		
		public function CameraWorldPositionConstant() 
		{
			super( 1 );
			_allowUpdater = true;
		}
		...
		{
			var tuple: Array = camera.position.toTuple();
