package zest3d.effects.local 
{
	 ...
	 * @author Gary Paluk
	 */
	public class VertexColor3Effect extends VisualEffect implements IDisposable 
	{
		...
		public function VertexColor3Effect() 
		{
			var vShader: VertexShader = new VertexShader( "Zest3D.VertexColor3", 2, 2, 1, 0, false );
			...
			vShader.setOutput( 1, "vertexColor", VariableType.FLOAT3, VariableSemanticType.COLOR0 );
			vShader.setConstant( 0, "PVWMatrix", 4 );
			vShader.setBaseRegisters( msVRegisters );
			vShader.setPrograms( msVPrograms );
			
			var pShader: PixelShader = new PixelShader( "Zest3D.VertexColor3", 1, 1, 0, 0, false );
			pShader.setInput( 0, "vertexColor", VariableType.FLOAT3, VariableSemanticType.COLOR0 );
		...
		public static function createUniqueInstance(): VisualEffectInstance
		{
			var effect: VertexColor3Effect = new VertexColor3Effect();
