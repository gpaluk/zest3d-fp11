...
package zest3d.resources.enum 
{
	...
	public class TextureFormat 
	{
		...
		public static const COMPRESSED: TextureFormat = new TextureFormat( "compressed", 24 );
		public static const COMPRESSED_ALPHA: TextureFormat = new TextureFormat( "compressedAlpha", 25 );
		
		public static const QUANTITY: int = 26;
