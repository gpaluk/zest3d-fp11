...
package zest3d.resources 
{
	 ...
	 * @author Gary Paluk
	 */
	public class Texture extends EventDispatcher implements IDisposable 
	{
		...
		public static const msNumDimensions: Array = [ 1, 2, 3, 2 ];
		public static const msPixelSize: Array = [ 0, 2, 2, 2, 1, 1, 2, 3, 4, 4, 2, 4, 8, 2, 4, 8, 4, 8, 16, 0, 0, 0, 4, 16, 16, 16 ]; //TODO check the last 3 pixel depths againa Adobes specs
		public static const msMipmapable: Array = [ false, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, false, false, false, true, true, true, false, true, false, false ];
		...
		public function Texture( format: TextureFormat, type: TextureType, usage: BufferUsageType, numLevels: int ) 
		{
			_format = format;
			_type = type;
			_usage = usage;
